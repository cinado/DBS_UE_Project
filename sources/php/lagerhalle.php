...
$logistikzentrumid = $lagerhallennummer = $lagerhallenhoehe = $lagerflaeche = '';
...
if (isset($_GET['lagerhallenhoehe'])) {
    $lagerhallenhoehe = $_GET['lagerhallenhoehe'];
}
if (isset($_GET['lagerflaeche'])) {
    $lagerflaeche = $_GET['lagerflaeche'];
}

$lagerhallen = $db->selectLagerhalle();
?>
